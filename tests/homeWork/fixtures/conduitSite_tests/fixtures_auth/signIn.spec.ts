...
import { expect } from '@playwright/test';
    ...
    async ({ signInPage, signUpPage }) => {   //фикстуры из файла fixtures.ts (там может быть что угодно: создание объектов, вывод чего-то в консоль, каието методы что угодно)
